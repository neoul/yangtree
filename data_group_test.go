...
func TestNewDataGroup(t *testing.T) {
	...
	jcontainernodes, err := NewDataNodeGroup(schema, nil, jcontainer)
	if err != nil {
		t.Fatal(err)
	}
	...
	jleaflistnodes, err := NewDataNodeGroup(schema, nil, jleaflist)
	if err != nil {
		t.Fatal(err)
	}
	...
	jlistnodes, err := NewDataNodeGroup(schema, nil, jlist)
	if err != nil {
		t.Fatal(err)
	}
